...
&$command -Repo $Repo -ResourceGroupName $HOL_RG -DeploymentName ConfigAdminAPI  -Location $AzureLocation -SiteName $ConfigAdminAPI  -ServicePlan $ConfigM_SP -DocDbURI $docdburi -DocDbKEY $docdbkey -RedisURI $redisuri
&$command -Repo $Repo -ResourceGroupName $HOL_RG -DeploymentName ConfigpublicAPI -Location $AzureLocation -SiteName $ConfigPublicAPI -ServicePlan $ConfigM_SP -DocDbURI $docdburi -DocDbKEY $docdbkey -RedisURI $redisuri
