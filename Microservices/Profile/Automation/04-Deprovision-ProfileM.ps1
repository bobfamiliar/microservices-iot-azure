<# 
.Synopsis 
    This PowerShell script de-provisions the ProfileM microservice
.Description 
    This PowerShell script de-provisions the ProfileM microservice
.Notes 
    File Name  : 04-Deprovision-ProfileM.ps1
    Author     : Bob Familiar
    ...
    Get-Help .\04-Deprovision-ProfileM.ps1 [Null], [-Full], [-Detailed], [-Examples]
