<# 
.Synopsis 
    This PowerShell script de-provisions the Biometrics Solution
.Description 
    This PowerShell script de-provisions the Biometrics Solution
.Notes 
    File Name  : 04-Deprovision-Biometrics.ps1
    Author     : Bob Familiar
    ...
    Get-Help .\04-Deprovision-Biometrics.ps1 [Null], [-Full], [-Detailed], [-Examples]
...
remove-azureresourcegroup -Name $Biometrics_RG -force

# add delete service bus namespaces
# add delete cloud service
