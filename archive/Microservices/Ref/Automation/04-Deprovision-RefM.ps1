<# 
.Synopsis 
    This PowerShell script de-provisions the RefM microservice
.Description 
    This PowerShell script de-provisions the RefM microservice
.Notes 
    File Name  : 04-Deprovision-RefM.ps1
    Author     : Bob Familiar
    ...
    Get-Help .\04-Deprovision-RefM.ps1 [Null], [-Full], [-Detailed], [-Examples]
...
remove-azureresourcegroup -Name $RefM_RG -force
