<# 
.Synopsis 
    This PowerShell script de-provisions the ConfigM microservice
.Description 
    This PowerShell script de-provisions the ConfigM microservice
.Notes 
    File Name  : 04-Deprovision-ConfigM.ps1
    Author     : Bob Familiar
    ...
    Get-Help .\04-Deprovision-ConfigM.ps1 [Null], [-Full], [-Detailed], [-Examples]
